...
const AdminInsuranceProducts = () => {
  ...
  function groupByRiskClass(data) {
    const grouped = {};
    data.forEach((item) => {
      if (!grouped[item.RiskClass]) {
        grouped[item.RiskClass] = { RiskClass: item.RiskClass, length: 0 };
      }
      grouped[item.RiskClass].length++;
    });
      ...
      <div style={{ flex: ".2" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ flex: ".7" }}>
              <h6>Accident</h6> <h2>{AccidentPolicy.length}</h2>{" "}
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ flex: ".7" }}>
              {" "}
              <h6>Bonds</h6> <h2>{bondPolicy.length}</h2>{" "}
            </div>
          </div>
          ...
          >
            ...
            <div style={{ flex: ".7" }}>
              <h6> Engineering </h6> <h2>{EngineeringPolicy.length}</h2>{" "}
            </div>
          </div>
        </Card>
      </div>
      ...
      <div style={{ flex: ".2" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ flex: ".7" }}>
              {" "}
              <h6>Fire </h6> <h2>{FirePolicy.length}</h2>{" "}
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ flex: ".7" }}>
              {" "}
              <h6>Health </h6> <h2>{HealthPolicy.length}</h2>{" "}
            </div>
          </div>
          ...
          >
            ...
            <div style={{ flex: ".7" }}>
              <h6> Liability </h6> <h2>{LiabilityPolicy.length}</h2>{" "}
            </div>
          </div>
        </Card>
      </div>
        ...
        >
          ...
          >
            {filteredPolicyBasedOnSelectedRiskClass.length === 0 ? (
              <h3>No {selectedRiskClass} policy created yet</h3>
            ) : (
              <table>
                <thead>
                  {" "}
...
export default AdminInsuranceProducts;
